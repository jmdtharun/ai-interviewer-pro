...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState('candidate@pro.com');
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-dark-card border border-dark-border rounded-3xl p-8 shadow-2xl flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center text-center gap-2">
          ...
          <p className="text-sm text-gray-400">Sign in to access your placement interview history</p>
        </div>
        ...
        <div className="text-center text-xs text-gray-400">
          Demo Candidate: <code className="text-brand-400 font-mono">candidate@pro.com</code> / <code className="text-brand-400 font-mono">password123</code>
        </div>
